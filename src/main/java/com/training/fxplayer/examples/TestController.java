...
public class TestController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		DoubleProperty widthProperty1 = imageView.fitWidthProperty();
		DoubleProperty hightProperty1 = imageView.fitHeightProperty();

		widthProperty1.bind(Bindings.selectDouble(imageView.sceneProperty(), "width"));
		hightProperty1.bind(Bindings.selectDouble(imageView.sceneProperty(), "height"));
	...
	public void handleOpenFileButtonClick(ActionEvent event) {
		File file = FILE_CHOOSER.showOpenDialog(Test.getPrimaryStage());
		...
		if (file != null) {
			...
			Test.setAppTitle(String.format(APP_TITLE_FORMAT, Player.APP_NAME, file.getName()));
	...
	public void handleKeyPresses() {
		stackPane.getScene().addEventFilter(KeyEvent.KEY_PRESSED, keyEvent -> {
			...
			case F11 -> Test.toggleFullScreen();
