...
public class Controller implements Initializable {
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		mediaVideo = new Media(new File("D:/My documents/Downloads/American Pie 1999.mp4").toURI().toString());
		mpVideo = new MediaPlayer(mediaVideo);
		mvVideo.setMediaPlayer(mpVideo);

		// Get the paths of the images and make them into images.
		Image imagePlay = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/play-btn.png").toURI().toString());
		...
		Image imageStop = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/stop-btn.png").toURI().toString());
		...
		Image imageRestart = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/restart-btn.png").toURI().toString());
		...
		Image imageVol = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/volume.png").toURI().toString());
		...
		Image imageFull = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/fullscreen.png").toURI().toString());
		...
		Image imageMute = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/mute.png").toURI().toString());
		ivMute = new ImageView(imageMute);
		ivMute.setFitWidth(35);
		ivMute.setFitHeight(35);

		// Exit full screen image.
		Image imageExit = new Image(
				new File("src/main/resources/com/training/fxplayer/examples/img/exitscreen.png").toURI().toString());
